<?php
// Add customizable widget for hero image
    function wpb_customize_register($wp_customize) {
        ...
        $wp_customize->add_setting('showcase_text', array(
            'default' => _x('Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, porro.', 'wpbootstrap'),
            'type'    => 'theme_mod'
        ));
        ...
        $wp_customize->add_setting('button_url', array(
            'default' => _x('http://devbox.com/wordpress/', 'wpbootstrap'),
            'type'    => 'theme_mod'
        ));
